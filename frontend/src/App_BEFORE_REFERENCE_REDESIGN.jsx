  ...
  return (
    <style>{`
      * {
      ...
      .card {
        background:
          linear-gradient(145deg, #0D2A3A 0%, #0A2233 58%, #EAFBFF 100%) !important;
        border-color: #234154 !important;
      ...
      .stat-card {
        background:
          linear-gradient(145deg, #102F42 0%, #0A2233 100%) !important;
      ...
      .category-card {
        background:
          linear-gradient(145deg, #0B2637 0%, #081E2E 100%) !important;
      ...
      .report-header {
        background:
          ...
          linear-gradient(135deg, #EAFBFF, #082D3D) !important;
      ...
      .stat-card,
      .category-card {
        background: linear-gradient(145deg, #0A2233 0%, #081D2C 100%) !important;
      ...
      .stat-card:nth-child(2n) {
        background: linear-gradient(145deg, #0D2A3A 0%, #092334 100%) !important;
      }

      .stat-card:nth-child(3n) {
        background: linear-gradient(145deg, #0A2635 0%, #071C2B 100%) !important;
      }
      ...
      .btn-primary {
        background: linear-gradient(135deg, #008F9C 0%, #008F9C 55%, #00B8C7 100%) !important;
      }
      ...
      .advanced-panel,
      .intelligence-panel {
        background: linear-gradient(145deg, #0A2233, #061C2A) !important;
      }
...
/* ===== AQUA XPLORE STRICT VISUAL SYSTEM ===== */
:root { color-scheme: dark; --ax-navy:#061826; --ax-navy-2:#0B2635; --ax-navy-3:#123443; --ax-border:#1B4A5A; --ax-teal:#008F9C; --ax-cyan:#00E5FF; --ax-ice:#EAFBFF; --ax-aqua:#45F5C3; }
html,body,#root{background:#061826!important;color:#EAFBFF!important}
body{background:radial-gradient(circle at 20% 0%,rgba(0,143,156,.14),transparent 30%),#061826!important}
.app-shell,.main-content,.content-area,.page-content{background:transparent!important;color:#EAFBFF!important}
.sidebar,.topbar{background:#061826!important;border-color:#1B4A5A!important}
.brand-title,.brand-aqua{color:#008F9C!important}.brand-x,.brand-xplore{color:#00E5FF!important;text-shadow:0 0 14px rgba(0,229,255,.45)!important}
.nav-item{color:#9CC9D2!important;background:transparent!important}.nav-item:hover,.nav-item.active{color:#00E5FF!important;background:rgba(0,229,255,.10)!important;border-color:rgba(0,229,255,.45)!important;box-shadow:inset 3px 0 #00E5FF,0 0 18px rgba(0,229,255,.08)!important}
.card{background:linear-gradient(145deg,#0B2635,#071D2A)!important;border:1px solid #1B4A5A!important;color:#EAFBFF!important}
.stat-card{background:linear-gradient(145deg,#123443,#0B2635)!important;border:1px solid rgba(0,229,255,.42)!important;color:#EAFBFF!important;box-shadow:0 10px 30px rgba(0,0,0,.25),inset 0 1px rgba(0,229,255,.08)!important}
.category-card{background:linear-gradient(145deg,rgba(0,143,156,.22),#0B2635)!important;border:1px solid rgba(0,143,156,.60)!important;color:#EAFBFF!important}
.result-card,.data-card,.panel,.table-card,.chart-card{background:#0B2635!important;border-color:#1B4A5A!important;color:#EAFBFF!important}
.card h1,.card h2,.card h3,.card h4,.stat-card h1,.stat-card h2,.stat-card h3,.category-card h1,.category-card h2,.category-card h3{color:#EAFBFF!important}.muted,.subtitle,.helper-text,.small-text{color:#9CC9D2!important}
.btn-primary,.primary-btn{background:linear-gradient(135deg,#008F9C,#00E5FF)!important;color:#061826!important;border-color:#00E5FF!important;box-shadow:0 0 18px rgba(0,229,255,.22)!important}.btn-outline,.btn-light,.secondary-btn{background:#0B2635!important;color:#EAFBFF!important;border-color:#1B4A5A!important}
input,textarea,select{background:#071D2A!important;color:#EAFBFF!important;border-color:#1B4A5A!important}input:focus,textarea:focus,select:focus{border-color:#00E5FF!important;box-shadow:0 0 0 2px rgba(0,229,255,.12),0 0 18px rgba(0,229,255,.10)!important}
.upload-zone,.drop-zone{background:rgba(0,229,255,.045)!important;border-color:rgba(0,229,255,.45)!important;color:#EAFBFF!important}.badge,.status-badge,.ai-badge{background:rgba(0,229,255,.10)!important;color:#00E5FF!important;border-color:rgba(0,229,255,.42)!important}
.confirmed,.risk-low,.success,.verified{color:#45F5C3!important;border-color:rgba(69,245,195,.45)!important;background:rgba(69,245,195,.08)!important}.risk-medium,.warning,.gps-error{color:#F6C76B!important;border-color:rgba(246,199,107,.45)!important;background:rgba(246,199,107,.08)!important}.risk-high,.danger,.error{color:#FF6B6B!important;border-color:rgba(255,107,107,.45)!important;background:rgba(255,107,107,.08)!important}
.progress-bar,.confidence-bar{background:#00E5FF!important;box-shadow:0 0 12px rgba(0,229,255,.35)!important}
.map-container,.survey-map,.digital-twin-stage{background:radial-gradient(circle at 50% 45%,rgba(0,229,255,.08),transparent 28%),linear-gradient(180deg,#061826,#071D2A)!important;border-color:#1B4A5A!important}.detection-marker,.sonar-marker,.twin-object{background:#00E5FF!important;border-color:#EAFBFF!important;box-shadow:0 0 0 4px rgba(0,229,255,.14),0 0 24px rgba(0,229,255,.55)!important}
.report-header{background:linear-gradient(135deg,#061826,#008F9C)!important;color:#EAFBFF!important}table{background:#0B2635!important;color:#EAFBFF!important;border-color:#1B4A5A!important}th{background:#123443!important;color:#00E5FF!important;border-color:#1B4A5A!important}td{background:#0B2635!important;color:#EAFBFF!important;border-color:#1B4A5A!important}tr:hover td{background:rgba(0,229,255,.055)!important}
.feature3-tab.active,.feature-tab.active{color:#00E5FF!important;border-color:#00E5FF!important;background:rgba(0,229,255,.10)!important}.ai-highlight,.ai-insight{color:#00E5FF!important;border-color:rgba(0,229,255,.50)!important;background:rgba(0,229,255,.07)!important}
/* ===== END STRICT VISUAL SYSTEM ===== */
      `}
    </style>
  );
}
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="card" style={{ marginTop: 16, border: "1px solid #103947", boxShadow: "none" }}>
                    <div className="card-header">
                      <div>
                    ...
                    <div className="card-body">
                      ...
                      <div style={{ marginTop: 12, padding: 12, borderRadius: 10, background: "#EAFBFF", border: "1px solid #D8F4FA" }}>
                  ...
                  <div style={{ marginTop: 16, padding: 14, borderRadius: 12, background: "#EAFBFF", border: "1px solid #D8F4FA" }}>
        ...
        {result && (
          <>
            ...
            {tab === "planning" && <>
              ...
              <div style={{ marginTop: 14, display: "grid", gap: 12 }}><div style={{ padding: 14, borderRadius: 12, background: "#EAFBFF", border: "1px solid #D8F4FA" }}><strong style={{ fontSize: 13 }}>AI Next-Survey Planner</strong><div className="small" style={{ marginTop: 6, lineHeight: 1.55 }}>{surveyPlan.recommendation || "Prototype survey recommendation generated from current evidence."}</div></div><div style={{ padding: 14, borderRadius: 12, background: "#EAFBFF", border: "1px solid #D8F4FA" }}><strong style={{ fontSize: 13 }}>Cleanup Mission Planner</strong><div className="small" style={{ marginTop: 6, lineHeight: 1.55 }}>{cleanup.recommendation || cleanup.summary || "Prototype mission-planning guidance; not an operational navigation route."}</div>{cleanup.target_fingerprints?.length ? <div className="small" style={{ marginTop: 7 }}>Prioritized fingerprints: {cleanup.target_fingerprints.join(", ")}</div> : null}</div></div>
        ...
        >
          <div>
            ...
            <select
              ...
              style={{ width: "100%", padding: "10px 12px", borderRadius: 10, border: "1px solid #B8DCE5", background: "#0B2635" }}
            >
