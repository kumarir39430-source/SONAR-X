  ...
  return (
    <style>{`
      * {
      ...
      .card {
        background:
          linear-gradient(145deg, #0D2A3A 0%, #0A2233 58%, #071A2A 100%) !important;
        border-color: #234154 !important;
      ...
      .digital-twin-stage {
        background:
          ...
          linear-gradient(145deg, #071A2A 0%, #061826 72%) !important;
        border-color: #008F9C !important;
      ...
      /* =========================================================
         AQUA XPLORE — FINAL VISUAL ENFORCEMENT
         This layer intentionally overrides legacy light surfaces.
         Palette is fixed: #061826 / #008F9C / #00E5FF /
         #EAFBFF / #45F5C3.
         ========================================================= */
      ...
      body {
        color: #EAFBFF !important;
        background:
          radial-gradient(circle at 88% 8%, rgba(0,229,255,.055), transparent 24%),
          radial-gradient(circle at 15% 90%, rgba(0,143,156,.045), transparent 28%),
          #061826 !important;
      }

      .app-shell {
        background:
          linear-gradient(180deg, rgba(6,24,38,.98), rgba(4,18,29,1)) !important;
      }
      ...
      .brand-aqua {
        color: #008F9C !important;
        text-shadow: 0 0 12px rgba(0,143,156,.18);
      }
      ...
      .sidebar {
        background:
          linear-gradient(180deg, #061826 0%, #071A2A 50%, #04131F 100%) !important;
        border-right: 1px solid rgba(0,229,255,.14) !important;
      }
      ...
      .nav-item:hover {
        background: rgba(0,143,156,.13) !important;
        color: #EAFBFF !important;
        border-color: rgba(0,143,156,.20) !important;
      }

      .nav-item.active {
        background:
          linear-gradient(90deg, rgba(0,143,156,.30), rgba(0,229,255,.12)) !important;
        color: #00E5FF !important;
        border-color: rgba(0,229,255,.22) !important;
        box-shadow:
          inset 3px 0 #00E5FF,
          0 0 18px rgba(0,229,255,.07) !important;
      }
      ...
      /* ---------- TOPBAR ---------- */
      .topbar {
        background: rgba(6,24,38,.94) !important;
        color: #EAFBFF !important;
      ...
      /* ---------- SURFACE HIERARCHY ----------
         Surface 0: page
         Surface 1: cards
         Surface 2: elevated/stat cards
         Surface 3: interactive/AI panels
         These are deliberately different. */
      .card {
        background:
          linear-gradient(145deg, #0D2A3A 0%, #0A2233 55%, #071A2A 100%) !important;
        border: 1px solid #234154 !important;
        box-shadow:
          0 16px 36px rgba(0,0,0,.26),
          inset 0 1px 0 rgba(234,251,255,.025) !important;
      }

      .stat-card {
        background:
          linear-gradient(145deg, #123447 0%, #0D2A3A 48%, #0A2233 100%) !important;
        border: 1px solid rgba(0,229,255,.22) !important;
        box-shadow:
          0 14px 32px rgba(0,0,0,.30),
          inset 0 1px 0 rgba(0,229,255,.08) !important;
      }

      .category-card {
        background:
          linear-gradient(145deg, #103947 0%, #0A2636 100%) !important;
        border: 1px solid rgba(0,143,156,.38) !important;
      ...
      .dataset-row {
        background:
          linear-gradient(145deg, #0A2636, #081E2C) !important;
        color: #EAFBFF !important;
        border-color: #29495A !important;
      }
      ...
      .hero {
        background:
          radial-gradient(circle at 82% 18%, rgba(0,229,255,.15), transparent 28%),
          linear-gradient(135deg, #061826 0%, #082B3B 62%, #008F9C 150%) !important;
        border: 1px solid rgba(0,229,255,.20) !important;
        box-shadow:
          0 20px 44px rgba(0,0,0,.30),
          inset 0 0 40px rgba(0,229,255,.035) !important;
      }
      ...
      .btn-primary {
        background:
          linear-gradient(135deg, #008F9C 0%, #00B8C7 65%, #00E5FF 130%) !important;
        color: #061826 !important;
        border: 1px solid rgba(0,229,255,.38) !important;
        box-shadow: 0 0 20px rgba(0,229,255,.14) !important;
      }

      .btn-primary:hover {
        background:
          linear-gradient(135deg, #008F9C, #00E5FF) !important;
        color: #061826 !important;
      ...
      .btn-outline {
        background: #0D2A3A !important;
        color: #EAFBFF !important;
        border: 1px solid #315466 !important;
      }
      ...
      .upload-zone {
        background:
          ...
          #0A2233 !important;
        border: 2px dashed #315466 !important;
      }

      .upload-zone:hover {
        background:
          radial-gradient(circle at 50% 0%, rgba(0,229,255,.14), transparent 48%),
          #0D2A3A !important;
        border-color: #00E5FF !important;
        box-shadow:
          inset 0 0 35px rgba(0,229,255,.055),
          0 0 22px rgba(0,229,255,.08) !important;
      }

      .gps-box {
        background:
          linear-gradient(135deg, rgba(0,143,156,.12), rgba(0,229,255,.045)) !important;
        border-color: rgba(0,229,255,.22) !important;
        color: #EAFBFF !important;
      }
      ...
      .sonar-marker > div {
        background: #00E5FF !important;
        border: 3px solid #EAFBFF !important;
        box-shadow:
          0 0 0 4px rgba(0,229,255,.12),
          0 0 24px rgba(0,229,255,.70) !important;
      }

      /* ---------- REPORTS ---------- */
      .report-header {
        background:
          radial-gradient(circle at 88% 5%, rgba(0,229,255,.16), transparent 28%),
          linear-gradient(135deg, #061826, #082D3D) !important;
        border: 1px solid rgba(0,229,255,.20) !important;
      }
      ...
      .risk-low {
        color: #45F5C3 !important;
        background: rgba(69,245,195,.09) !important;
        border: 1px solid rgba(69,245,195,.22) !important;
      }
      ...
      .digital-twin-stage {
        background:
          radial-gradient(circle at 50% 28%, rgba(0,229,255,.13), transparent 35%),
          linear-gradient(180deg, #061826 0%, #072536 48%, #0A3042 100%) !important;
        border: 1px solid #008F9C !important;
        box-shadow:
          inset 0 0 80px rgba(0,229,255,.055),
      ...
      .twin-grid-lines {
        background-image:
          ...
          linear-gradient(90deg, rgba(0,229,255,.34) 1px, transparent 1px) !important;
      }
      ...
      .recharts-legend-item-text {
        fill: #B8DCE5 !important;
        color: #B8DCE5 !important;
      }

      .recharts-cartesian-grid line {
        stroke: rgba(125,211,252,.10) !important;
      }
      ...
      .intelligence-panel {
        background:
          linear-gradient(145deg, #0D2A3A, #071A2A) !important;
        border-color: rgba(0,229,255,.20) !important;
        box-shadow:
          0 14px 32px rgba(0,0,0,.26),
          inset 0 0 30px rgba(0,229,255,.025) !important;
      }

      .expert-confirmed {
        color: #45F5C3 !important;
        background: rgba(69,245,195,.09) !important;
        border-color: rgba(69,245,195,.22) !important;
      }

      /* Never allow legacy light surfaces to leak through the final theme. */
      .card,
      .stat-card,
      .category-card,
      .file-pill,
      ...
      ::selection {
        background: rgba(0,229,255,.30) !important;
        color: #EAFBFF !important;
      }
        ...
        >
          <div>
            ...
            <select
              ...
              style={{ width: "100%", padding: "10px 12px", borderRadius: 10, border: "1px solid #B8DCE5", background: "white" }}
            >
