...
function App() {
  ...
  const analyzeFile = async () => {
    ...
    try {
      ...
      /*
        Fallback to /detect if the backend uses
      ...
      */
      ...
      alert(
        "Analysis failed. Make sure your FastAPI backend is running at http://127.0.0.1:8000."
      );
    } finally {
      setLoading(false);
    }
